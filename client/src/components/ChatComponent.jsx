...
const ChatComponent = ({SeletedUser,setSeletedUser}) => {
  ...
  return SeletedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      <div className='flex items-center gap-3 py-3 mx-3 border-b border-stone-500'>
        ...
        <img onClick={()=>setSeletedUser(null)} src={assets.arrow_icon} alt="Arrow icon" className='md:hidden max-w-7'/>
        <img src={assets.help_icon} alt="Help icon" className='max-wd:hidden max-w-5'/>
      </div>
        ...
        {messagesDummyData.map((msg,index)=>(
          <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
            ...
            <div className='text-center text-xs'>
              <img src={msg.senderId==='680f50e4f10f3cd28382ecf9' ? assets.avatar_icon : assets.profile_martin} alt="Profile image"  className='w-7 rounded-full'/>
